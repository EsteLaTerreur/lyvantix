...
function chargerTexte() {
    ...
    .then(contenu => {
        ...
        var texteAvecSpans;
        var titreAvecSpans;
        (texteAvecSpans, titreAvecSpans)=traitement_txt(contenu);

        document.getElementById('corpsADeviner').innerHTML = texteAvecSpans;
        document.getElementById('titreADeviner').innerHTML = titreAvecSpans;
        cacherMots();
    })
    .catch(error => {
